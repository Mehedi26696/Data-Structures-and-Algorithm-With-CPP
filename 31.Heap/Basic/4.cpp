...
// 3. If the new element is smaller than its parent node, swap the new element with its parent node.
...
// 3. If the new root is larger than its children, swap the root with the smaller child.
// 4. Repeat steps 2 and 3 until the new root is in the correct position.
